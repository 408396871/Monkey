...
@interface UserDetailViewController ()<UITableViewDataSource,UITableViewDelegate,UINavigationControllerDelegate,TapBubbleDelegate>{
...
//    }
    ...
    _bubble.webUrl = _userModel.blog;
