...
@interface RepositoryDetailViewController ()<UITableViewDataSource,UITableViewDelegate,UINavigationControllerDelegate,TapBubbleDelegate>{
...
-(void)homePageAction{
    ...
    _bubble.webUrl = _model.homepage;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UserModel  *model;
    if (currentIndex==1 && [self.DsOfPageListObject1.dsArray isKindOfClass:[NSNull class]]) {
        model = [(self.DsOfPageListObject1.dsArray) objectAtIndex:indexPath.row];
        
    }else if (currentIndex==2 && [self.DsOfPageListObject2.dsArray isKindOfClass:[NSNull class]]){
        
        model = [(self.DsOfPageListObject2.dsArray) objectAtIndex:indexPath.row];
        
    }else if (currentIndex==3 && [self.DsOfPageListObject3.dsArray isKindOfClass:[NSNull class]]){
        
        model = [(self.DsOfPageListObject3.dsArray) objectAtIndex:indexPath.row];
